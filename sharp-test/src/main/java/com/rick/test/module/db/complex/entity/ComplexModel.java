...
//    private IdCodeValue plant;
     ...
     */
    @Column(comment = "分类", value = "category_list", nullable = false, columnDefinition = "json")
    private List<CodeDescription.CategoryEnum> categoryList;

    @Column(comment = "字典分类", value = "category_dict_list", nullable = false, columnDefinition = "json")
    @DictType(type = "CategoryEnum")
