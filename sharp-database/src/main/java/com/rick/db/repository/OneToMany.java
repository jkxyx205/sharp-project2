...
public @interface OneToMany {
    ...
    /**
     * 当 cascadeSave = true 的时候，是否执行删除操作
     * cascadeSaveItemDelete 只会在 cascadeSave = true 或 cascadeDelete = true 生效
     * @return
     */
    ...
    /**
     * 删除前检查callback
     * 当 cascadeSaveItemDelete = true 的时候，是否执行删除前检查操作
     * cascadeSaveItemDeleteCheck 只会在 cascadeSaveItemDelete = true 或 cascadeDelete = true 生效 生效
     * @return
     */
